...
public class LogiTechItemGroups {
    public static void registerGroups(SlimefunAddon plugin){
        ROOT.register(plugin);
        INFORMATION.register(plugin);
        BASIC_MATERIAL.register(plugin);
    ...
    public static final ItemGroup BASIC_MATERIAL =new DummyItemGroup(AddUtils.getNameKey("material" ), LogiTechSlimefunItemStacks.BASIC_MATERIAL);

    public static final ItemGroup BASIC =new DummyItemGroup(AddUtils.getNameKey("basic" ), LogiTechSlimefunItemStacks.BASIC);

    public static final ItemGroup CARGO = new DummyItemGroup(AddUtils.getNameKey("cargo" ), LogiTechSlimefunItemStacks.CARGO);

    public static final ItemGroup SINGULARITY= new DummyItemGroup(AddUtils.getNameKey("singularity"),LogiTechSlimefunItemStacks.SINGULARITY);

    public static final ItemGroup ADVANCED= new DummyItemGroup(AddUtils.getNameKey("advanced" ), LogiTechSlimefunItemStacks.ADVANCED);

    public static final ItemGroup BEYOND= new DummyItemGroup(AddUtils.getNameKey("beyond" ), LogiTechSlimefunItemStacks.BEYOND);

    public static final ItemGroup VANILLA= new DummyItemGroup(AddUtils.getNameKey("vanilla" ), LogiTechSlimefunItemStacks.VANILLA);

    public static final ItemGroup MANUAL = new DummyItemGroup(AddUtils.getNameKey("manual" ), LogiTechSlimefunItemStacks.MANUAL);

    public static final ItemGroup SPECIAL = new DummyItemGroup(AddUtils.getNameKey("special" ), LogiTechSlimefunItemStacks.SPECIAL);

    public static final ItemGroup SPACE = new DummyItemGroup(AddUtils.getNameKey("space"),LogiTechSlimefunItemStacks.SPACE);

    public static final ItemGroup GENERATORS = new DummyItemGroup(AddUtils.getNameKey("generators"),LogiTechSlimefunItemStacks.GENERATORS);

    public static final ItemGroup ENERGY= new DummyItemGroup(AddUtils.getNameKey("energy"),LogiTechSlimefunItemStacks.ENERGY);

    public static final ItemGroup TOOLS_FUNCTIONAL =new DummyItemGroup(AddUtils.getNameKey("tools-functional"),LogiTechSlimefunItemStacks.TOOLS){
        @Override
    ...
    public static final ItemGroup TOOLS_SUBGROUP_1 = new DummyItemGroup(AddUtils.getNameKey("tools-sub1"),LogiTechSlimefunItemStacks.TOOLS_SUBGROUP_1);
    public static final ItemGroup TOOLS_SUBGROUP_2 = new DummyItemGroup(AddUtils.getNameKey("tools-sub2"),LogiTechSlimefunItemStacks.TOOLS_SUBGROUP_2);


    public static final ItemGroup FUNCTIONAL=new DummyItemGroup(AddUtils.getNameKey("functional"),LogiTechSlimefunItemStacks.FUNCTIONAL);



    public static ItemGroup MORE2=new CustomItemGroup(AddUtils.getNameKey("more2"),AddUtils.color("宇宙安全说明"),LogiTechSlimefunItemStacks.NOTICE,54,36,new LinkedHashMap<>()) {
        @Override
    ...
    public static ItemGroup UPDATELOG=new CustomItemGroup(AddUtils.getNameKey("log"),AddUtils.colorful("更新日志"),LogiTechSlimefunItemStacks.UPDATE_LOG,54,36,new LinkedHashMap<>()) {
        @Override
    ...
    public static ItemGroup BUGCRAFTER=new CustomItemGroup(bugcrafterId,AddUtils.colorful(AddUtils.ADDON_NAME),LogiTechSlimefunItemStacks.ALLBIGRECIPES,54,36,new LinkedHashMap<>()) {
        ...
        protected void init(MenuFactory factory) {
            ...
            factory.addOverrides(4,LogiTechSlimefunItemStacks.GITHUB_URL,(Player player1, int i1, ItemStack itemstack1, ClickAction clickAction) -> {
    ...
    public static final ItemGroup INFORMATION =new CustomItemGroup(AddUtils.getNameKey("info"),null, LogiTechSlimefunItemStacks.INFORMATION,54,36,new LinkedHashMap<>()) {
        @Override
        protected void init(MenuFactory factory) {
            this.setVisble(false);
            factory.addInventory(1,LogiTechSlimefunItemStacks.INFO_1);
            factory.addInventory(11,LogiTechSlimefunItemStacks.INFO_2);
            factory.addInventory(21,LogiTechSlimefunItemStacks.INFO_3);
            factory.addInventory(7,LogiTechSlimefunItemStacks.INFO_4);
            factory.addInventory(15,LogiTechSlimefunItemStacks.INFO_5);
            factory.addInventory(23,LogiTechSlimefunItemStacks.INFO_6);
            factory.addInventory(13,LogiTechSlimefunItemStacks.WIKI,(Player player1, int i1, ItemStack itemstack1, ClickAction clickAction) -> {
            ...
            factory.addInventory(27,LogiTechSlimefunItemStacks.FEAT1);
            factory.addInventory(28,LogiTechSlimefunItemStacks.FEAT2);
            factory.addInventory(29,LogiTechSlimefunItemStacks.FEAT3);
            factory.addInventory(30,LogiTechSlimefunItemStacks.FEAT4);
            factory.addInventory(31,LogiTechSlimefunItemStacks.FEAT5);
            factory.addInventory(32,LogiTechSlimefunItemStacks.FEAT6);
            factory.addInventory(33,LogiTechSlimefunItemStacks.FEAT7);
            factory.addInventory(34,LogiTechSlimefunItemStacks.FEAT8);
            factory.addInventory(35,LogiTechSlimefunItemStacks.FEAT9);
            factory.addOverrides(4,LogiTechSlimefunItemStacks.MATL114);
        }
        @Override
        protected void addGuideRelated(ChestMenu menu, Player p, PlayerProfile profile, SlimefunGuideMode mode, int pages) {
            for(int s=0;s<2;++s){
                ...
                if(menu.getItemInSlot(rand+9)==null){
                    menu.replaceExistingItem(rand+9,AddUtils.getWithoutId( LogiTechSlimefunItemStacks.BUG));
                    menu.addMenuClickHandler(rand+9,((player, i, itemStack, clickAction) -> {
                        AddUtils.forceGive(player,LogiTechSlimefunItemStacks.BUG,1);
    ...
    public static final ItemGroup TOOLS=new me.matl114.matlib.implement.slimefun.menu.guideMenu.CustomItemGroup(AddUtils.getNameKey("tools"),LogiTechSlimefunItemStacks.TOOLS,true)
            .setLoader(new CustomMenuGroup(LogiTechSlimefunItemStacks.TOOLS.getItemMeta().getDisplayName(),54,1){{
                            //initialize
                            enablePresets((i)->{
                            ...
                            .addItem(0,LogiTechSlimefunItemStacks.TOOLS_RECIPES,(cm)-> (GuideClickHandler)(Player var1, int var2, ItemStack var3, ClickAction var4, PlayerProfile var5, SlimefunGuideMode var6, FlexItemGroup var7, int var8)->{
    ...
    public static final ItemGroup ROOT=new CustomItemGroup(itemGroupId,AddUtils.colorful(AddUtils.ADDON_NAME), LogiTechSlimefunItemStacks.ROOT,54,108,
                new LinkedHashMap<>(){{
                    put(2,BASIC_MATERIAL);
                    put(0,INFORMATION);
                    put(27,BUGCRAFTER);
                    put(4,BASIC);
                    put(3,MANUAL);
...
//        }
        ...
        public void init(MenuFactory factory){
            ...
            //对模板内的填充物进行修改
            factory.addInventory(9,LogiTechSlimefunItemStacks.STACKABLE_MACHINE);
            factory.addInventory(18,LogiTechSlimefunItemStacks.ALLRECIPE);
            factory.addInventory(27,LogiTechSlimefunItemStacks.ALLBIGRECIPES);
            factory.addInventory(35,LogiTechSlimefunItemStacks.TOBECONTINUE);
            ...
            ItemStack h4=new CustomItemStack(CustomHead.HGTLPBBIHead.getItem(),AddUtils.color("HgTlPbBi"),"&7点击查看详情");
            ...
            ItemStack h6=new CustomItemStack(LogiTechSlimefunItemStacks.MATL114,"  ","&8..?");
            ...
            ItemStack it=new CustomItemStack(LogiTechSlimefunItemStacks.MATL114,AddUtils.color("你觉得..."),continueStr);
            ...
            it=new CustomItemStack(LogiTechSlimefunItemStacks.MATL114,AddUtils.color("我能在患有痴呆症的情况下完成逻辑工艺的编写吗?"),continueStr);
            smetas[0]=it.getItemMeta();
            it=new CustomItemStack(LogiTechSlimefunItemStacks.MATL114,AddUtils.color("这能被完成么,这可能完成么?"),continueStr);
            smetas[1]=it.getItemMeta();
            it=new CustomItemStack(LogiTechSlimefunItemStacks.MATL114,AddUtils.color("我知道这有点难"),continueStr);
            smetas[2]=it.getItemMeta();
            it=new CustomItemStack(LogiTechSlimefunItemStacks.MATL114,AddUtils.color("所以,我想"),continueStr);
            smetas[3]=it.getItemMeta();
            it=new CustomItemStack(LogiTechSlimefunItemStacks.MATL114,AddUtils.color("今年我要进行一项从未有人达成过的挑战"),continueStr);
        ...
        final ItemMeta s4=new CustomItemStack(CustomHead.HGTLPBBIHead.getItem(),AddUtils.color("HgTlPbBi"),"&7逻辑工艺的支持者","&7提出了很多有用的点子").getItemMeta();
        ...
        final ItemMeta s6=new CustomItemStack(CustomHead.PDCECDMDHead.getItem(),"  ","&7看得出你的视力很好","&7所以一定要仔细阅读","&7版本说明与机器说明哦").getItemMeta();
